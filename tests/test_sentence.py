"""Test cases for Sentence module."""
...
def word_collection_file_path() -> Path:
    """
    Get path to full word collection file.

    :return: Path to the full word collections file.
    """
...
class TestSentence():
    """Test case for the Sentences class."""
    ...
    def test_splitting_words(self, mock_sentence: 'Sentence'):
        """Test case for splitting sentences into words."""
